...
It combines a Next.js frontend with a FastAPI backend and PM4Py-based analysis tools. The project includes bundled starter assets for local and deployed use.
