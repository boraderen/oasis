              ...
              <div className="algorithm-metrics">
                ...
                <div className="metric-section">
                  ...
                  <div className="metric-row">
                    ...
                    <span className="metric-value">{heuristicsData.num_places}</span>
                  </div>
                  <div className="metric-row">
                    <span className="metric-label">Transitions</span>
                    <span className="metric-value">{heuristicsData.num_transitions}</span>
                  </div>
                  <div className="metric-row">
                    <span className="metric-label">Arcs</span>
                    <span className="metric-value">{heuristicsData.num_arcs}</span>
                  </div>
                </div>
              </div>
            ) : (
